...
<head>
  ...
  <style>
    ...
    .auth-shell{ min-height:calc(100vh - 10rem); display:grid; align-content:start; justify-items:center; gap:.35rem; padding:3.5rem 0 1.5rem; }
    ...
    @media (max-width: 520px){
      ...
      .auth-shell{ align-content:start; justify-items:stretch; gap:.45rem; padding-top:1.25rem; }
